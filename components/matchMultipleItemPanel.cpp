/**
 * @file matchMultipleItemPanel.cpp
 *
 */

#include "../include/components/matchMultipleItemPanel.h"

MatchMultipleItemPanel::MatchMultipleItemPanel(wxPanel* parent,wxString title) : wxPanel(parent,wxID_ANY,wxDefaultPosition,wxDefaultSize,wxBORDER_NONE){
	...
	this->mItem_cherry_label = new wxStaticText(this,wxID_ANY,L"CHERRY",wxDefaultPosition,wxDefaultSize);
	    this->mItem_cherry_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_CHERRY,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_apple_label = new wxStaticText(this,wxID_ANY,L"APPLE",wxDefaultPosition,wxDefaultSize);
		this->mItem_apple_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_APPLE,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_orange_label = new wxStaticText(this,wxID_ANY,L"ORANGE",wxDefaultPosition,wxDefaultSize);
		this->mItem_orange_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_ORANGE,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_coin_label = new wxStaticText(this,wxID_ANY,L"COIN",wxDefaultPosition,wxDefaultSize);
		this->mItem_coin_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_COIN,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_bar_label = new wxStaticText(this,wxID_ANY,L"BAR",wxDefaultPosition,wxDefaultSize);
		this->mItem_bar_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_BAR,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_diamond_label = new wxStaticText(this,wxID_ANY,L"DIAMOND",wxDefaultPosition,wxDefaultSize);
		this->mItem_diamond_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_DIAMOND,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_crown_label = new wxStaticText(this,wxID_ANY,L"CROWN",wxDefaultPosition,wxDefaultSize);
		this->mItem_crown_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_CROWN,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_multiple_label = new wxStaticText(this,wxID_ANY,L"Multiple",wxDefaultPosition,wxDefaultSize);
		this->mItem_multiple_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_MULTIPLE,L"",wxDefaultPosition,wxSize(50,22),0,validator);

	this->mItem_train_label = new wxStaticText(this,wxID_ANY,L"Train",wxDefaultPosition,wxDefaultSize);
		this->mItem_train_tc = new wxTextCtrl(this,CID_MATCH_MULTIPLE_ITEM_TRAIN,L"",wxDefaultPosition,wxSize(50,22),0,validator);
	...
	Connect(CID_MATCH_MULTIPLE_ITEM_CHERRY,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_APPLE,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_ORANGE,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_COIN,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_BAR,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_DIAMOND,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_CROWN,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_MULTIPLE,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
	Connect(CID_MATCH_MULTIPLE_ITEM_TRAIN,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(MatchMultipleItemPanel::AfterEdit));
}

void MatchMultipleItemPanel::AfterEdit(wxCommandEvent& event){
	unsigned int tmp;
	...
	if(tmp > 10000){
	  ...
	  wxMessageDialog *dial = new wxMessageDialog(NULL,L"Match Multiple ItemP anel Sum Over 10000",L"Error", wxOK | wxICON_ERROR);
	  dial->ShowModal();
	}else if(tmp < 10000){
	  this->mTotalValue_tc->SetForegroundColour(wxColour(255,0,0));
	}else{
